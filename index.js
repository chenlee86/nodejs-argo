...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.cl999.eu.org';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNTg0OTAyYjAzNjAzMzM0NDZiNWY4OGNiZGMxYWViMmIiLCJ0IjoiYjdlZmU2YWUtMzlhNC00ODdiLTllNzUtZTk2Y2UzNDZhOTkxIiwicyI6Ik1UWXlZV1ptWVRjdFlqSXhaQzAwWkdZM0xUazVZV0V0T1dSaVpqSTBPR05pWXpVeCJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
const ARGO_PORT = process.env.ARGO_PORT || 8001;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
const CFIP = process.env.CFIP || '104.20.0.0';         // 节点优选域名或优选ip  
const CFPORT = process.env.CFPORT || 2053;                   // 节点优选域名或优选ip对应的端口
